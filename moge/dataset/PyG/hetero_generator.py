...
class HeteroNodeClfDataset(HeteroGraphDataset):
    ...
    def __init__(self, dataset: HeteroData, neighbor_loader: str = "NeighborLoader",
                 ...
                 pred_ntypes: List[str] = None, edge_dir: str = "in", add_reverse_metapaths: bool = False,
                 undirected_ntypes: List[str] = None, inductive: bool = False, **kwargs):
        """
...
class HeteroLinkPredDataset(HeteroNodeClfDataset):
    def __init__(self, dataset: HeteroData, negative_sampling_size=1000, neighbor_loader: str = "NeighborLoader",
                 neighbor_sizes: Union[List[int], Dict[str, List[int]]] = [128, 128], node_types: List[str] = None,
                 metapaths: List[Tuple[str, str, str]] = None, head_node_type: str = None, edge_dir: str = "in",
                 add_reverse_metapaths: bool = True, inductive: bool = False, train_test_split="edge_mask", **kwargs):
        """
        ...
        Args:
            ...
            **kwargs ():
        """
        super().__init__(dataset, neighbor_loader=neighbor_loader, neighbor_sizes=neighbor_sizes, node_types=node_types,
                         ...
                         train_test_split=train_test_split, **kwargs)
